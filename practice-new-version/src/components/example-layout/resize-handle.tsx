...
/**
 * The drag handle between the chat and app panels. `max-lg:hidden` because below the `lg`
 * breakpoint app mode hides the chat panel entirely, so there are no two panels to divide.
 *
 * Pointer capture (rather than window listeners) keeps move events coming to this element
 * even when the pointer outruns the 6px hit area mid-drag.
 */
